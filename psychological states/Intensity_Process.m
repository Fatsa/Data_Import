...
% return
% intensity_Lines means the information of expectation
% intensity_Count means the info line num + 1
function [intensity_Lines, intensity_Count]=Intensity_Process(fileName, pathName)
    ...
    if (0 ~= message) 
        ...
        while ~feof(ioStream)
            ...
            intensity_Lines{intensity_Count,1}=titleLine;
