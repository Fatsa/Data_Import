...
% return
% saddness_Lines means the information of saddness
% saddness_Count means the info line num + 1
function [saddness_Lines, saddness_Count]=Saddness_Process(fileName, pathName)
    ...
    if (0 ~= message) 
        ...
        while ~feof(ioStream)
            ...
            saddness_Lines{saddness_Count,1}=titleLine;
            saddness_Count=saddness_Count+1;
        end
    end
